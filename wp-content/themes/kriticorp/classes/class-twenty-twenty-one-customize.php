...
if ( ! class_exists( 'kriticorp_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since kriticorp 1.0
	 */
	class kriticorp_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'kriticorp' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'kriticorp' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'kriticorp' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'kriticorp' ),
						'full'    => esc_html__( 'Full text', 'kriticorp' ),
					),
				)
			);
			...
			$wp_customize->register_control_type( 'kriticorp_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new kriticorp_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'kriticorp' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
